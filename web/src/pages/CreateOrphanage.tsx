...
export default function CreateOrphanage() {
  ...
  function handleSelectItems(event: ChangeEvent<HTMLInputElement>) {
            ...
            <div className="input-block">
              ...
              <div className="images-container">
                ...
                <label htmlFor="image[]" className="new-image">
                  ...
                  <input multiple onChange={handleSelectItems} type="file" id="image[]" />
                </label>
              </div>
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <div className="button-select">
                ...
                <button type="button" onClick={() => setOpenOnWeekends(false)} className={!open_on_weekends ? 'active' : ''}>False</button>
              </div>
            </div>
          </fieldset>
